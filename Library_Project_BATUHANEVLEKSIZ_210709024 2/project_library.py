...
while 1:
    ...
    if todo == 'add':
        ...
        try:
            ...
            delete_book = input("Which book do you want to delete? Enter the ISBN number or Book's Name: ")
            ...
            print(f"{files_name} dosyası bulunamadı.")
        ...
        if user_wanttt == 'books':
            ...
            try:
                with open(files_name, 'r') as file:
                    ...
                    found_info = input("Enter ISBN number or Book's: ")
            ...
            try:
                with open(files_name, 'r') as file:
                    ...
                    found_info = input("Enter Students ID or Students name: ")
            ...
            try:
                with open(files_name, 'r') as file:
                    ...
                    found_info = input("Enter ISBN number or Books name or Student's ID: ")
        ...
        try:
            ...
            takenn_book = input("Which book do you want to give? Enter the ISBN number: ")
            ...
            if is_checked_out:
                ...
                with open(taken_files_name, 'a') as taken_file:
                    ...
                    info_number = input("What is your students number: ")
                    info_name = input("What is your name: ").lower()
                    info_surname = input("What is students surname: ").lower()
                    
                    datee = input("What is the release date of the book:  ")
            ...
            print(f"{files_name_books} dosyası bulunamadı.")
        except Exception as hata:
            print(f"Bir hata oluştu: {hata}")
        ...
        try:
            ...
            takenn_book = input("Which book do you want to take? Enter the ISBN number: ")
            student_id = input("Enter student's ID: ")
